            ...
            <tr>
                ...
                <td>
                    <fieldset>
                        ...
                        <p>
                            <label for="loco--com_api_key">
                                <?php $ui->e('api_key')?>:
                            </label>
                            <input type="text" size="50" name="api[com][key]" id="loco--com_api_key" value="https://laban.webnew.info.vn/api.php" spellcheck="false" />
                        </p>
                        <p>
                            <label for="loco--com_api_region">
                                <?php $ui->e('api_region')?>:
                            </label>
                            <input type="text" size="20" name="api[com][region]" id="loco--com_api_region" value="<?php $api->e('region')?>" spellcheck="false" placeholder="global" />
                        </p>
                        <p>
                            <span class="description"><a href="https://webnew.info.vn" target="_blank" tabindex="-1">https://webnew.info.vn</a></span>
                        </p>
                    </fieldset>
                </td>
            </tr>
